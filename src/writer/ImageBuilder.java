...
public final class ImageBuilder implements BaselineCompiler.ClassResolver
{
    ...
    public CodeBuffer build(String entryKey)
    {
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VM.ensureInitByName(J)V",   "vm/VM.ensureInitAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMConcat.scBool(JI)V",       "vm/VM.scBoolAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMConcat.scDouble(JJ)V",     "vm/VM.scDoubleAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMConcat.scFloat(JI)V",      "vm/VM.scFloatAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.printStr(J)V",      "vm/VM.printStrAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.recordHash(J)J",     "vm/VM.recordHashAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.recordEquals(JJ)J",  "vm/VM.recordEqualsAddr");
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.methodParamTypes(J)J", "vm/VM.paramTypesAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.methodReturnType(J)J", "vm/VM.returnTypeAddr");
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.staticCell(JJ)J",   "vm/VM.staticCellAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.sockNoop()V",        "vm/VM.sockNoopAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.shutdownBeforeHalt()V", "vm/VM.shutdownBeforeHaltAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.shutdownHalt0(J)V",  "vm/VM.shutdownHalt0Addr");
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.hwEntropy(JJ)J", "vm/VM.hwEntropyAddr"); // SecureRandom.hwEntropy0
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.methodAnnoAll(J)J", "vm/VM.methodAnnoAllAddr"); // Method.annoAll0
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.classAnnoAll(J)J", "vm/VM.classAnnoAllAddr"); // Class.annoAll0
        stashHelper(image, staticWord, wordOffset, "vm/VMNatives.classDeclClasses(J)J", "vm/VM.classDeclClassesAddr"); // Class.declaredClasses0
