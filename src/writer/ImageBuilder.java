...
public final class ImageBuilder implements BaselineCompiler.ClassResolver
{
    ...
    public CodeBuffer build(String entryKey)
    {
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VMScheduler.pipTask(I)V",       "vm/VM.pipTaskAddr");
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VM.newUnresolved(J)V", "vm/VM.newUnresolvedAddr"); // unresolvable `new`
