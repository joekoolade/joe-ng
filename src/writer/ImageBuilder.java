...
public final class ImageBuilder implements BaselineCompiler.ClassResolver
{
    ...
    public CodeBuffer build(String entryKey)
    {
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VM.taskA()V",          "vm/VM.taskAAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.taskB()V",          "vm/VM.taskBAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.taskC()V",          "vm/VM.taskCAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.taskR()V",          "vm/VM.taskRAddr");
        ...
        stashHelper(image, staticWord, wordOffset, "vm/VM.monEnter(J)V",      "vm/VM.monEnterAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.monExit(J)V",       "vm/VM.monExitAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.holdsLock(J)I",     "vm/VM.holdsLockAddr");
        stashHelper(image, staticWord, wordOffset, "vm/VM.interrupt(J)V",     "vm/VM.interruptAddr");
