...
final class MetalWriterSymbols implements Symbols
{
    ...
    public int intrinsicId(int methodCp)
    {
        ...
        if (utf8Is(n, Magic.bytes("readX0"))) { return Intrinsics.READ_X0; }
        if (utf8Is(n, Magic.bytes("readX16"))) { return Intrinsics.READ_X16; }
        ...
        if (utf8Is(n, Magic.bytes("readCNTP_CTL_EL0"))) { return Intrinsics.READ_CNTP_CTL_EL0; }
