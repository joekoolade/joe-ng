...
public final class VM
{
    ...
    static final int LOCK_REFLECT     = 11; // a VMNatives reflection entry: parses, so it re-points the context
    ...
    private static void printLockSite(int site)
    {
        ...
        if (site == LOCK_REFLECT)     { Uart.write(Magic.bytes("reflection native")); return; }
