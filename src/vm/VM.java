...
public final class VM
{
    ...
    static final int BLOB_COUNT = 64;    // ...+ Map + Collection + Collections + Comparable
    ...
    private static byte[] blobClass(int b)
    {
        ...
        return Magic.bytes("java/lang/Comparable");
    }
    ...
    private static byte[] blobAddrName(int b)
    {
        ...
        return Magic.bytes("comparableBytes");
    }
    ...
    private static byte[] blobLenName(int b)
    {
        ...
        return Magic.bytes("comparableLen");
    }
